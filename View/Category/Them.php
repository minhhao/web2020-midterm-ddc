  ...
  <tr height="30" bgcolor="">
    <td colspan="2" class="tieude" align="center" style="font-style:oblique; color:#FFF"><strong>THÊM LOẠI SẢN PHẨM MỚI</strong></td>
  </tr>
  <form action="admin.php?mod=Category&act=Them" method="post" class="form" enctype="multipart/form-data">
  </tr>
  <tr bgcolor="">
    <td style="padding-left:80px" height="30">Tên Loại Muốn Thêm :</td>
    <td><input type="text" name="txtTenLoai" id="txtTenNSX" /></td>
  </tr>
  <tr bgcolor="">
